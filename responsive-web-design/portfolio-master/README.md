...
_Reto: Crear una página portfolio-master siguiendo el diseño propuesto por [DevChallenges](https://devchallenges.io/challenges/5ZnOYsSXM24JWnCsNFlt). La página debe ser responsiva. No se debe mirar la solución existente. Cumpla con las historias de usuario que aparecen a continuación:_

### Historias de Usuario
- _Puedo ver una página que sigue el diseño dado creada en [figma](https://www.figma.com/file/O7Omgz2iVR7Vox7shf7O8e/portfolio) ._

### Previsualización 
![imagen](https://github.com/jean-carlos-19/portfolio-master/blob/master/captura/escritorio.png)

### Demo
_Puedes encontrar la implementacion del desafio [aqui](https://piguavejc-portfolio-master.onrender.com/)_
...
$git clone https://github.com/jean-carlos-19/portfolio-master
