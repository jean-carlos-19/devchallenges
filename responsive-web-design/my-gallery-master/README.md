...
### Demo :eyes:
_Puedes encontrar la implementacion del desafio [aqui](https://piguavejc-my-gallery-master.onrender.com/)_
...
$git clone https://github.com/jean-carlos-19/my-gallery-master

#2. Dirigete a la carpeta. 
$ cd my-gallery-master
